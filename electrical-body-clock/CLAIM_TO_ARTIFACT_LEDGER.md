...
1. **Locked confirmatory null (strongest).** The composite phase-disagreement
   ...
   and a whole-ECG clock — a single, pre-registered, firewall-protected reveal on
   an untouched CODE-15 final split. This is the discovery: **A carries; D does
   not.**
...
| AV / ST-T gaps carry independent hazard (OOS) | z_AV p = 3.7×10⁻²¹, z_STT p = 2.2×10⁻⁷ | `results/act1_ecg/reveal/CODE_CONFIRMATORY_RESULT.md` |
